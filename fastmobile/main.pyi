...
def WhenSelected(**kwargs: Any) -> FT: ...
def WhenPressed(**kwargs: Any) -> FT: ...

# Behavior
def Behavior(*children: Any, **kwargs: Any) -> FT: ...
def Back(**kwargs: Any) -> Behavior: ...
def Dispatch(event_name:str, **kwargs: Any) -> Behavior: ...
def On(event_name:str, **kwargs: Any) -> Behavior: ...
...
# Other
def Empty() -> FT: ...
def DispatchBack(event_name) -> View: ...
